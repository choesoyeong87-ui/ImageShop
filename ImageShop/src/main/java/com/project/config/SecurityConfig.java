...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		 ...
		 * // HTTP 세션 무효화 (기본값: true) .deleteCookies("JSESSIONID", "remember-me") //
		 * 로그아웃 시 관련 쿠키 삭제 .permitAll() // 로그아웃 요청은 누구나 접근 가능해야 함 );
		 * 
		 * //6.자동로그인기능 설정 // 데이터 소스를 지정하고 테이블을 이용해서 기존 로그인 정보를 기록 // 쿠키의 유효 시간을
		 * 지정한다(24시간). // 6. 자동 로그인(Remember-Me) 설정 수정 /*
